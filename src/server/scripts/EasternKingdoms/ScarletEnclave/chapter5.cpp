...
enum mograine
{
    ...
    SAY_LIGHT_OF_DAWN01               = 85, // pre text
    SAY_LIGHT_OF_DAWN02               = 84,
    SAY_LIGHT_OF_DAWN03               = 83,
    SAY_LIGHT_OF_DAWN04               = 82, // intro
    SAY_LIGHT_OF_DAWN05               = 81,
    SAY_LIGHT_OF_DAWN06               = 80,
    SAY_LIGHT_OF_DAWN07               = 79, // During the fight - Korfax, Champion of the Light
    SAY_LIGHT_OF_DAWN08               = 78, // Lord Maxwell Tyrosus
    SAY_LIGHT_OF_DAWN09               = 77, // Highlord Darion Mograine
    SAY_LIGHT_OF_DAWN10               = 76,
    SAY_LIGHT_OF_DAWN11               = 75,
    SAY_LIGHT_OF_DAWN12               = 74,
    SAY_LIGHT_OF_DAWN13               = 73,
    SAY_LIGHT_OF_DAWN14               = 72,
    SAY_LIGHT_OF_DAWN15               = 71,
    SAY_LIGHT_OF_DAWN16               = 70,
    SAY_LIGHT_OF_DAWN17               = 69,
    SAY_LIGHT_OF_DAWN18               = 68,
    SAY_LIGHT_OF_DAWN19               = 67,
    SAY_LIGHT_OF_DAWN20               = 66,
    SAY_LIGHT_OF_DAWN21               = 65,
    SAY_LIGHT_OF_DAWN22               = 64,
    SAY_LIGHT_OF_DAWN23               = 63,
    SAY_LIGHT_OF_DAWN24               = 62,
    SAY_LIGHT_OF_DAWN25               = 61, // After the fight
    SAY_LIGHT_OF_DAWN26               = 60, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN27               = 59, // Highlord Darion Mograine
    SAY_LIGHT_OF_DAWN28               = 58, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN29               = 57, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN30               = 56, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN31               = 55, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN32               = 54, // Highlord Alexandros Mograine
    SAY_LIGHT_OF_DAWN33               = 53, // Highlord Darion Mograine
    SAY_LIGHT_OF_DAWN34               = 52, // Highlord Darion Mograine
    SAY_LIGHT_OF_DAWN35               = 51, // Darion Mograine
    SAY_LIGHT_OF_DAWN36               = 50, // Darion Mograine
    SAY_LIGHT_OF_DAWN37               = 49, // Highlord Alexandros Mograine
    SAY_LIGHT_OF_DAWN38               = 48, // Darion Mograine
    SAY_LIGHT_OF_DAWN39               = 47, // Highlord Alexandros Mograine
    SAY_LIGHT_OF_DAWN40               = 46, // Darion Mograine
    SAY_LIGHT_OF_DAWN41               = 45, // Highlord Alexandros Mograine
    SAY_LIGHT_OF_DAWN42               = 44, // Highlord Alexandros Mograine
    SAY_LIGHT_OF_DAWN43               = 43, // The Lich King
    SAY_LIGHT_OF_DAWN44               = 42, // Highlord Darion Mograine
    SAY_LIGHT_OF_DAWN45               = 41, // The Lich King
    SAY_LIGHT_OF_DAWN46               = 40, // The Lich King
    SAY_LIGHT_OF_DAWN47               = 39, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN48               = 38, // The Lich King
    SAY_LIGHT_OF_DAWN49               = 37, // The Lich King
    SAY_LIGHT_OF_DAWN50               = 36, // Lord Maxwell Tyrosus
    SAY_LIGHT_OF_DAWN51               = 35, // The Lich King
    SAY_LIGHT_OF_DAWN52               = 34, // Highlord Darion Mograine
    SAY_LIGHT_OF_DAWN53               = 33, // Highlord Darion Mograine
    SAY_LIGHT_OF_DAWN54               = 32, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN55               = 31, // The Lich King
    SAY_LIGHT_OF_DAWN56               = 30, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN57               = 29, // The Lich King
    SAY_LIGHT_OF_DAWN58               = 28, // The Lich King
    SAY_LIGHT_OF_DAWN59               = 27, // The Lich King
    SAY_LIGHT_OF_DAWN60               = 26, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN61               = 25, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN62               = 24, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN63               = 23, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN64               = 22, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN65               = 21, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN66               = 20, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN67               = 19, // Highlord Tirion Fordring
    SAY_LIGHT_OF_DAWN68               = 18, // Highlord Darion Mograine

    EMOTE_LIGHT_OF_DAWN01             = 17,  // Emotes
    EMOTE_LIGHT_OF_DAWN02             = 16,
    EMOTE_LIGHT_OF_DAWN03             = 15,
    EMOTE_LIGHT_OF_DAWN04             = 14,
    EMOTE_LIGHT_OF_DAWN05             = 13,
    EMOTE_LIGHT_OF_DAWN06             = 12,
    EMOTE_LIGHT_OF_DAWN07             = 11,
    EMOTE_LIGHT_OF_DAWN08             = 10,
    EMOTE_LIGHT_OF_DAWN09             = 9,
    EMOTE_LIGHT_OF_DAWN10             = 8,
    EMOTE_LIGHT_OF_DAWN11             = 7,
    EMOTE_LIGHT_OF_DAWN12             = 6,
    EMOTE_LIGHT_OF_DAWN13             = 5,
    EMOTE_LIGHT_OF_DAWN14             = 4,
    EMOTE_LIGHT_OF_DAWN15             = 3,
    EMOTE_LIGHT_OF_DAWN16             = 2,
    EMOTE_LIGHT_OF_DAWN17             = 1,
    EMOTE_LIGHT_OF_DAWN18             = 0,
...
public:
                    ...
                    switch (Step)
                    {
                        ...
                        case 15: // summon gate
                            if (Unit* temp = me->SummonCreature(NPC_HIGHLORD_ALEXANDROS_MOGRAINE, LightofDawnLoc[22].x, LightofDawnLoc[22].y, LightofDawnLoc[22].z, LightofDawnLoc[22].o, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 300000))
                            {
								...
								if (temp->ToCreature())
									temp->ToCreature()->AI()->Talk(EMOTE_LIGHT_OF_DAWN06);
                        ...
                        case 18: // Darion's spirit out
                            ...
                            {
								if (temp->ToCreature())
									temp->ToCreature()->AI()->Talk(SAY_LIGHT_OF_DAWN35);
                                temp->SetWalk(false);
                        ...
                        case 29: // lich king spawns
                            ...
                            {
								if (temp->ToCreature())
									temp->ToCreature()->AI()->Talk(SAY_LIGHT_OF_DAWN43);
    ...
    //   doesn't make it looks well, so workarounds, Darion charges, looks better
                        ...
                        case 41: // Lich king - Apocalypse
                            if (Creature* temp = Unit::GetCreature(*me, LichKingGUID))
                            {
                                ...
                                if (Unit* tirion = Unit::GetCreature(*me, TirionGUID))
                                {
									...
									if (tirion->ToCreature())
										tirion->ToCreature()->AI()->Talk(EMOTE_LIGHT_OF_DAWN12);
                                }
                            }
                            JumpToNextStep(2000);
                            break;
            ...
            else
            {
                ...
                {
                    Talk(RAND(SAY_LIGHT_OF_DAWN09, SAY_LIGHT_OF_DAWN10, SAY_LIGHT_OF_DAWN11,
                ...
                if (Fight_duration <= diff + 5000)
                {
                    if (!TirionGUID)
                        if (Unit* temp = me->SummonCreature(NPC_HIGHLORD_TIRION_FORDRING, LightofDawnLoc[0].x, LightofDawnLoc[0].y, LightofDawnLoc[0].z, 1.528f, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, 600000))
                        {
							...
							if (temp->ToCreature())
								temp->ToCreature()->AI()->Talk(SAY_LIGHT_OF_DAWN25);
