...
{
    //say
    SAY_MAKE_PREPARATIONS         = 16,
    SAY_TEMPLE_OF_PROMISE         = 15,
    SAY_MUST_CONTINUE             = 14,
    SAY_BANISH_THE_SPIRITS        = 13,
    SAY_CAVERNS_PURIFIED          = 12,
    SAY_BEYOND_THIS_CORRIDOR      = 11,
    SAY_EMERALD_DREAM             = 10,
    SAY_MUTANUS_THE_DEVOURER      = 5,
    SAY_NARALEX_AWAKES            = 3,
    SAY_THANK_YOU                 = 2,
    SAY_FAREWELL                  = 1,
    SAY_ATTACKED                  = 0,
    //yell
    ...
    SAY_I_AM_AWAKE                = 4,
    //emote
    EMOTE_AWAKENING_RITUAL        = 9,
    EMOTE_TROUBLED_SLEEP          = 8,
    EMOTE_WRITHE_IN_AGONY         = 7,
    EMOTE_HORRENDOUS_VISION       = 6,
    //spell
