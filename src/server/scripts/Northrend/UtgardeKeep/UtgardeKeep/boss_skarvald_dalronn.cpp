...
enum eEnums
{
    ...
    YELL_SKARVALD_AGGRO                         = 4,
    YELL_SKARVALD_DAL_DIED                      = 3,
    YELL_SKARVALD_SKA_DIEDFIRST                 = 2,
    YELL_SKARVALD_KILL                          = 1,
    YELL_SKARVALD_DAL_DIEDFIRST                 = 0,

    //signed for 24201, but used by 24201, 27389
    YELL_DALRONN_AGGRO                          = 4,
    YELL_DALRONN_SKA_DIED                       = 3,
    YELL_DALRONN_DAL_DIEDFIRST                  = 2,
    YELL_DALRONN_KILL                           = 1,
    YELL_DALRONN_SKA_DIEDFIRST                  = 0,
