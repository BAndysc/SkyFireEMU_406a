...
enum Yells
{
    ...
    SAY_KRICK_SLAY_1                            = 11,
    SAY_KRICK_SLAY_2                            = 10,
    SAY_KRICK_BARRAGE_1                         = 9,
    SAY_KRICK_BARRAGE_2                         = 8,
    SAY_KRICK_POISON_NOVA                       = 7,
    SAY_KRICK_CHASE_1                           = 6,
    SAY_KRICK_CHASE_2                           = 5,
    SAY_KRICK_CHASE_3                           = 4,

    // Ick
    SAY_ICK_POISON_NOVA                         = 1,
    SAY_ICK_CHASE_1                             = 0,

    // OUTRO
    SAY_KRICK_OUTRO_1                           = 3,
    SAY_JAYNA_OUTRO_2                           = 5,
    SAY_SYLVANAS_OUTRO_2                        = 4,
    SAY_KRICK_OUTRO_3                           = 2,
    SAY_JAYNA_OUTRO_4                           = 4,
    SAY_SYLVANAS_OUTRO_4                        = 3,
    SAY_KRICK_OUTRO_5                           = 1,
    SAY_TYRANNUS_OUTRO_7                        = 14,
    SAY_KRICK_OUTRO_8                           = 0,
    SAY_TYRANNUS_OUTRO_9                        = 13,
    SAY_JAYNA_OUTRO_10                          = 3,
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_PURSUIT:
                            if (Creature* krick = GetKrick())
                                krick->AI()->Talk(RAND(SAY_KRICK_CHASE_1, SAY_KRICK_CHASE_2, SAY_KRICK_CHASE_3));
    ...
    public:
        ...
        struct boss_krickAI : public ScriptedAI
        {
            ...
            void KilledUnit(Unit* victim)
            {
                ...
                Talk(RAND(SAY_KRICK_SLAY_1, SAY_KRICK_SLAY_2));
            }
            ...
            void HandleScriptEffect(SpellEffIndex /*effIndex*/)
            {
                ...
                if (Unit* target = ickAI->SelectTarget(SELECT_TARGET_RANDOM, 0, 200.0f, true))
                {
					if (caster->ToCreature())
						caster->ToCreature()->AI()->Talk(SAY_ICK_CHASE_1, target->GetGUID());
