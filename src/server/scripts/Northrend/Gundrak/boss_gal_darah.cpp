...
enum Yells
{
    ...
    SAY_SLAY_3                                    = 6,
    SAY_DEATH                                     = 5,
    SAY_SUMMON_RHINO_1                            = 4,
    SAY_SUMMON_RHINO_2                            = 3,
    SAY_SUMMON_RHINO_3                            = 2,
    SAY_TRANSFORM_1                               = 1,  //Phase change
    SAY_TRANSFORM_2                               = 0
};
                ...
                case TROLL:
                    ...
                    else
                    {
                        if (uiStampedeTimer <= diff)
                        {
                            ...
                            Talk(RAND(SAY_SUMMON_RHINO_1, SAY_SUMMON_RHINO_2, SAY_SUMMON_RHINO_3));
