...
enum NpcTextIds
{
    SAY_PRINCE_LIAM_GREYMANE_1                         = 2,
    SAY_PRINCE_LIAM_GREYMANE_2                         = 1,
    SAY_PRINCE_LIAM_GREYMANE_3                         = 0,
    DELAY_SAY_PRINCE_LIAM_GREYMANE                     = 20000, // 20 seconds repetition time

    YELL_PRINCE_LIAM_GREYMANE_1                        = 4,
    YELL_PRINCE_LIAM_GREYMANE_2                        = 3,
    YELL_PRINCE_LIAM_GREYMANE_3                        = 2,
    YELL_PRINCE_LIAM_GREYMANE_4                        = 1,
    YELL_PRINCE_LIAM_GREYMANE_5                        = 0,
    DELAY_YELL_PRINCE_LIAM_GREYMANE                    = 2000,

    SAY_PANICKED_CITIZEN_1                             = 7,
    SAY_PANICKED_CITIZEN_2                             = 6,
    SAY_PANICKED_CITIZEN_3                             = 5,
    SAY_PANICKED_CITIZEN_4                             = 4,

    SAY_GILNEAS_CITY_GUARD_GATE_1                      = 7,
    SAY_GILNEAS_CITY_GUARD_GATE_2                      = 6,
    SAY_GILNEAS_CITY_GUARD_GATE_3                      = 5,
