...
enum EternalBoard
{
    ...
    ANACHRONOS_SAY_9                    = 4,
    ANACHRONOS_SAY_10                   = 3,
    ANACHRONOS_EMOTE_1                  = 2,
    ANACHRONOS_EMOTE_2                  = 1,
    ANACHRONOS_EMOTE_3                  = 0,
    ...
    struct npc_anachronos_the_ancientAI : public ScriptedAI
    {
        ...
        void HandleAnimation()
        {
            ...
            if (eventEnd == false)
            {
                ...
                {
                        Fandral->AI()->Talk(ANACHRONOS_SAY_1, me->GetGUID());
                        break;
                    case 1:
                    ...
                    case 29:
                        ...
                        Fandral->AI()->Talk(FANDRAL_SAY_2, me->GetGUID());
                        break;
                    case 30:
                        break;
                    case 31:
                    ...
                    case 52:
                        ...
                        Talk(ANACHRONOS_SAY_9, Fandral->GetGUID());
                        break;
                    case 53:
