...
enum Yells
{
    SAY_FACE_ANGER_AGGRO                          = 18,
    SAY_FACE_DESIRE_AGGRO                         = 17,
    SAY_FACE_ANGER_SLAY_1                         = 16,
    SAY_FACE_SORROW_SLAY_1                        = 15,
    SAY_FACE_DESIRE_SLAY_1                        = 14,
    SAY_FACE_ANGER_SLAY_2                         = 13,
    SAY_FACE_SORROW_SLAY_2                        = 12,
    SAY_FACE_DESIRE_SLAY_2                        = 11,
    SAY_FACE_SORROW_DEATH                         = 9,
    SAY_FACE_DESIRE_DEATH                         = 8,
    EMOTE_MIRRORED_SOUL                           = 7,
    EMOTE_UNLEASH_SOUL                            = 6,
    SAY_FACE_ANGER_UNLEASH_SOUL                   = 5,
    SAY_FACE_SORROW_UNLEASH_SOUL                  = 4,
    SAY_FACE_DESIRE_UNLEASH_SOUL                  = 3,
    EMOTE_WAILING_SOUL                            = 2,
    SAY_FACE_ANGER_WAILING_SOUL                   = 1,
    SAY_FACE_DESIRE_WAILING_SOUL                  = 0,
    ...
    public:
        ...
        struct boss_devourer_of_soulsAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/)
            {
                ...
                Talk(RAND(SAY_FACE_SORROW_DEATH, SAY_FACE_DESIRE_DEATH));
