...
enum eFloppy
{
    ...
    SAY_WORGHAGGRO1             = 12, //Um... I think one of those wolves is back...
    SAY_WORGHAGGRO2             = 11, //He's going for Mr. Floppy!
    SAY_WORGRAGGRO3             = 10, //Oh, no! Look, it's another wolf, and it's a biiiiiig one!
    SAY_WORGRAGGRO4             = 9, //He's gonna eat Mr. Floppy! You gotta help Mr. Floppy! You just gotta!
    SAY_RANDOMAGGRO             = 8, //There's a big meanie attacking Mr. Floppy! Help!
    SAY_VICTORY1                = 7, //Let's get out of here before more wolves find us!
    SAY_VICTORY2                = 6, //Don't go toward the light, Mr. Floppy!
    SAY_VICTORY3                = 5, //Mr. Floppy, you're ok! Thank you so much for saving Mr. Floppy!
    SAY_VICTORY4                = 4, //I think I see the camp! We're almost home, Mr. Floppy! Let's go!
    TEXT_EMOTE_WP1              = 3, //Mr. Floppy revives
    TEXT_EMOTE_AGGRO            = 2, //The Ravenous Worg chomps down on Mr. Floppy
    SAY_QUEST_ACCEPT            = 1, //Are you ready, Mr. Floppy? Stay close to me and watch out for those wolves!
    SAY_QUEST_COMPLETE          = 0  //Thank you for helping me get back to the camp. Go tell Walter that I'm safe now!
};
...
enum eSkirmisher
{
    ...
    RANDOM_SAY_1             =  2,        //Ahh..better..
    RANDOM_SAY_2             =  1,        //Whoa.. i nearly died there. Thank you, $Race!
    RANDOM_SAY_3             =  0         //Thank you. $Class!
};
        ...
        void SpellHit(Unit* caster, const SpellInfo* spell)
        {
                ...
                && caster->ToPlayer()->GetQuestStatus(12288) == QUEST_STATUS_INCOMPLETE)
            {
				...
				if (caster->ToCreature())
					caster->ToCreature()->AI()->Talk(RAND(RANDOM_SAY_1, RANDOM_SAY_2, RANDOM_SAY_3));
                if (me->IsStandState())
                ...
                if (Player* player = Unit::GetPlayer(*me, uiPlayerGUID))
                {
                    switch (uiTimer)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            Talk(RAND(SAY_SEO1, SAY_SEO2, SAY_SEO3, SAY_SEO4, SAY_SEO5));
