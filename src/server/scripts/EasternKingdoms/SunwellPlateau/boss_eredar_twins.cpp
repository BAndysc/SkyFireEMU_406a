...
{
    //Alytesh
    YELL_CANFLAGRATION          =   14,
    YELL_SISTER_SACROLASH_DEAD  =   13,
    YELL_ALY_KILL_1             =   12,
    YELL_ALY_KILL_2             =   11,
    YELL_ALY_DEAD               =   10,
    YELL_BERSERK                =   9,
...
public:
    ...
    struct boss_sacrolashAI : public ScriptedAI
    {
        ...
        {
            if (rand()%4 == 0)
                Talk(RAND(YELL_SAC_KILL_1, YELL_SAC_KILL_2));
        }
...
public:
    ...
    struct boss_alythessAI : public Scripted_NoMovementAI
    {
        ...
        void KilledUnit(Unit* /*victim*/)
        {
            if (rand()%4 == 0)
            {
                Talk(RAND(YELL_ALY_KILL_1, YELL_ALY_KILL_2));
            }
        }
