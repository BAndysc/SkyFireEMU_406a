...
enum Yells
{
    SAY_AMBUSH_1                    = 12,
    SAY_AMBUSH_2                    = 11,
    SAY_GAUNTLET_START              = 10,
    SAY_TYRANNUS_INTRO_1            = 9,
    SAY_GORKUN_INTRO_2              = 2,
    SAY_TYRANNUS_INTRO_3            = 8,

    SAY_AGGRO                       = 7,
    SAY_SLAY_1                      = 6,
    SAY_SLAY_2                      = 5,
    SAY_DEATH                       = 4,
    SAY_MARK_RIMEFANG_1             = 3,
    SAY_MARK_RIMEFANG_2             = 2,
    SAY_DARK_MIGHT_1                = 1,
    SAY_DARK_MIGHT_2                = 0,

    SAY_GORKUN_OUTRO_1              = 1,
    SAY_GORKUN_OUTRO_2              = 0,
    SAY_JAYNA_OUTRO_3               = 2,
    SAY_SYLVANAS_OUTRO_3            = 1,
    SAY_JAYNA_OUTRO_4               = 1,
    SAY_SYLVANAS_OUTRO_4            = 0,
    SAY_JAYNA_OUTRO_5               = 0,
};
        ...
        struct boss_tyrannusAI : public BossAI
        {
            ...
            void UpdateAI(const uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    {
                        case EVENT_INTRO_1:
                            //pGorkunOrVictus->AI()->Talk(SAY_GORKUN_INTRO_2);
                            break;
                        case EVENT_INTRO_2:
