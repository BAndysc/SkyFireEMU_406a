...
enum eEnums
{
    //kael'thas Speech
    SAY_INTRO                           = 18,
    SAY_INTRO_CAPERNIAN                 = 17,
    SAY_INTRO_TELONICUS                 = 16,
    SAY_INTRO_THALADRED                 = 15,
    SAY_INTRO_SANGUINAR                 = 14,
    SAY_PHASE2_WEAPON                   = 13,
    SAY_PHASE3_ADVANCE                  = 12,
    SAY_PHASE4_INTRO2                   = 11,
    SAY_PHASE5_NUTS                     = 10,
    SAY_SLAY1                           = 9,
    SAY_SLAY2                           = 8,
    SAY_SLAY3                           = 7,
    ...
    SAY_GRAVITYLAPSE1                   = 4,
    SAY_GRAVITYLAPSE2                   = 3,
    SAY_SUMMON_PHOENIX1                 = 2,
    SAY_SUMMON_PHOENIX2                 = 1,
    SAY_DEATH                           = 0,

    //Thaladred the Darkener speech
    SAY_THALADRED_AGGRO                 = 2,
    SAY_THALADRED_DEATH                 = 1,
    EMOTE_THALADRED_GAZE                = 0,

    //Lord Sanguinar speech
    SAY_SANGUINAR_AGGRO                 = 1,
    SAY_SANGUINAR_DEATH                 = 0,

    //Grand Astromancer Capernian speech
    SAY_CAPERNIAN_AGGRO                 = 1,
    SAY_CAPERNIAN_DEATH                 = 0,

    //Master Engineer Telonicus speech
    SAY_TELONICUS_AGGRO                 = 1,
    SAY_TELONICUS_DEATH                 = 0,
                ...
                switch (Phase)
                {
                    ...
                    case 6:
                    {
                        ...
                        if (Phoenix_Timer <= diff)
                        {
                            ...
                            Talk(RAND(SAY_SUMMON_PHOENIX1, SAY_SUMMON_PHOENIX2));
                        ...
                        if (Phase == 6)
                        {
                            ...
                            if (GravityLapse_Timer <= diff)
                            {
                                ...
                                switch (GravityLapse_Phase)
                                {
                                    ...
                                    case 1:
                                        Talk(RAND(SAY_GRAVITYLAPSE1, SAY_GRAVITYLAPSE2));
