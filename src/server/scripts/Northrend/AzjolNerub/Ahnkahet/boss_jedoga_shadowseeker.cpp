...
{
    TEXT_AGGRO                                    = 13,
    TEXT_SACRIFICE_1_1                            = 12,
    TEXT_SACRIFICE_1_2                            = 11,
    TEXT_SACRIFICE_2_1                            = 10,
    TEXT_SACRIFICE_2_2                            = 9,
    TEXT_SLAY_1                                   = 8,
    TEXT_SLAY_2                                   = 7,
    TEXT_SLAY_3                                   = 6,
    TEXT_DEATH                                    = 5,
...
public:
    ...
    struct boss_jedoga_shadowseekerAI : public ScriptedAI
    {
        ...
        void KilledUnit(Unit* Victim)
        {
            ...
            Talk(RAND(TEXT_SLAY_1, TEXT_SLAY_2, TEXT_SLAY_3));
        }
        ...
        void MoveInLineOfSight(Unit* who)
        {
            ...
            {
                Talk(RAND(TEXT_PREACHING_1, TEXT_PREACHING_2, TEXT_PREACHING_3, TEXT_PREACHING_4, TEXT_PREACHING_5));
                bPreDone = true;
            }
        ...
        void OpferRufen()
        {
            ...
            if (opfer)
            {
                Talk(RAND(TEXT_SACRIFICE_1_1, TEXT_SACRIFICE_1_2));
        ...
        void Opfern()
        {
            Talk(RAND(TEXT_SACRIFICE_2_1, TEXT_SACRIFICE_2_2));
