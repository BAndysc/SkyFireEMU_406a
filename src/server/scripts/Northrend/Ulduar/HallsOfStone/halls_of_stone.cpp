...
enum Texts
{
    ...
    SAY_LOW_HEALTH                      = 49,
    SAY_DEATH                           = 48,
    SAY_PLAYER_DEATH_1                  = 47,
    SAY_PLAYER_DEATH_2                  = 46,
    SAY_PLAYER_DEATH_3                  = 45,
    SAY_ESCORT_START                    = 44,

    SAY_SPAWN_DWARF                     = 43,
    SAY_SPAWN_TROGG                     = 42,
    SAY_SPAWN_OOZE                      = 41,
    SAY_SPAWN_EARTHEN                   = 40,

    SAY_EVENT_INTRO_1                   = 39,
    SAY_EVENT_INTRO_2                   = 38,
    SAY_EVENT_INTRO_3_ABED              = 37,

    SAY_EVENT_A_1                       = 36,
    SAY_EVENT_A_2_KADD                  = 35,
    SAY_EVENT_A_3                       = 34,

    SAY_EVENT_B_1                       = 33,
    SAY_EVENT_B_2_MARN                  = 32,
    SAY_EVENT_B_3                       = 31,

    SAY_EVENT_C_1                       = 30,
    SAY_EVENT_C_2_ABED                  = 29,
    SAY_EVENT_C_3                       = 28,

    SAY_EVENT_D_1                       = 27,
    SAY_EVENT_D_2_ABED                  = 26,
    SAY_EVENT_D_3                       = 25,
    SAY_EVENT_D_4_ABED                  = 24,

    SAY_EVENT_END_01                    = 23,
    SAY_EVENT_END_02                    = 22,
    SAY_EVENT_END_03_ABED               = 21,
    SAY_EVENT_END_04                    = 20,
    SAY_EVENT_END_05_ABED               = 19,
    SAY_EVENT_END_06                    = 18,
    SAY_EVENT_END_07_ABED               = 17,
    SAY_EVENT_END_08                    = 16,
    SAY_EVENT_END_09_KADD               = 15,
    SAY_EVENT_END_10                    = 14,
    SAY_EVENT_END_11_KADD               = 13,
    SAY_EVENT_END_12                    = 12,
    SAY_EVENT_END_13_KADD               = 11,
    SAY_EVENT_END_14                    = 10,
    SAY_EVENT_END_15_MARN               = 9,
    SAY_EVENT_END_16                    = 8,
    SAY_EVENT_END_17_MARN               = 7,
    SAY_EVENT_END_18                    = 6,
    SAY_EVENT_END_19_MARN               = 5,
    SAY_EVENT_END_20                    = 4,
    SAY_EVENT_END_21_ABED               = 3,

    SAY_VICTORY_SJONNIR_1               = 2,
    SAY_VICTORY_SJONNIR_2               = 1,
